...
public class AdminLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (Current.DB.checkAdmin(Email)) {
            if (Current.DB.ValidateAdmin(Email, Current.DB.EncryptPassword(Password))) {
                Admin admin = Current.DB.getAdmin(Email);
                Cookie email = new Cookie("Email", Email);
                Cookie userID = new Cookie("UserID", admin.getUserid());

                String Session = Current.GenerateSessionCode(admin.getUserid());
