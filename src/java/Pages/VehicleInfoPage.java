 ...
 * @author E6440
 */
public class VehicleInfoPage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (map.size() != 0 && Current.DB.checkUser(map.get("Email")) && Current.DB.CheckSession(map.get("UserID"), map.get("SessionCode"))) {
            ...
            request.setAttribute("vehicle", user.getMyVehicle(ChasisNo));
            RequestDispatcher rd = request.getRequestDispatcher("VehicleInfo.jsp");
